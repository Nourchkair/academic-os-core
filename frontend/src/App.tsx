  ...
  return (
    <div className="app-shell">
      ...
      <main className="main-content">
        ...
        {error ? <ConnectionNotice message={error} onRetry={() => void refresh()} /> : <>{view === 'home' && <Home status={status} tasks={tasks} reviews={reviews} activity={activity} onNavigate={setView} />}{view === 'courses' && <Courses courses={courses} />}{view === 'tasks' && <Tasks tasks={tasks} />}{view === 'library' && <Library courses={courses} />}{view === 'review' && <Review reviews={reviews} activity={activity} />}{view === 'settings' && <Settings status={status} />}</>}
      </main>
    </div>
  )
}
