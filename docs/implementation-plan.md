...
- **Small observational dashboard update:** Home labels the existing Review count as “Open decisions”; Courses exposes an explicit AI-created material category/badge; no chatbot or major Review workflow was added.
